                            ...
                            size_t num_ports)
{
    (void) cfg;
    (void) num_ports;
    SER2NET_LOGW("ser2net_adapter", "STM32 serial backend not implemented yet");
    return NULL;
}

BaseType_t
ser2net_stm32_register_port(const struct ser2net_stm32_serial_port_cfg *cfg)
{
    (void) cfg;
...
void
ser2net_stm32_unregister_port(int port_id)
{
    (void) port_id;
}
